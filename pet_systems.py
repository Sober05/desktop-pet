...
from PyQt5.QtWidgets import QMenu, QAction, QSystemTrayIcon, QLabel
...
class PetSystems:
    ...
    def _setup_menu(self):
        ...
        self._menu.setStyleSheet("""
            QMenu { background: #1e1e2e; color: #e0e0e0;
                    border: 1px solid #FF8C42; border-radius: 4px; }
    ...
    def _toggle_top(self):
        ...
        if flags & Qt.WindowStaysOnTopHint:
            self.pet.setWindowFlags(flags & ~Qt.WindowStaysOnTopHint)
        else:
            self.pet.setWindowFlags(flags | Qt.WindowStaysOnTopHint)
        self.pet.show()
    ...
    def _show_bubble(self, text):
        ...
        bubble.setStyleSheet("""
            background: #1e1e2e; color: #FF8C42; font-size: 12px;
            border: 1px solid #FF8C42; border-radius: 8px; padding: 4px 8px;
        """)
        bubble.adjustSize()
